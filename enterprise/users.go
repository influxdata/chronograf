...
func (c *UserStore) Add(ctx context.Context, u *chronograf.DBUser) (*chronograf.DBUser, error) {
...
func (c *UserStore) Delete(ctx context.Context, u *chronograf.DBUser) error {
	return c.Ctrl.DeleteUser(ctx, u.Name)
}

// Get retrieves a user if name exists.
func (c *UserStore) Get(ctx context.Context, name string) (*chronograf.DBUser, error) {
...
func (c *UserStore) Update(ctx context.Context, u *chronograf.DBUser) error {
...
func (c *UserStore) All(ctx context.Context) ([]chronograf.DBUser, error) {
	...
	res := make([]chronograf.DBUser, len(all.Users))
