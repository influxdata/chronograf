...
type DashboardCell struct {
	...
	Separators    *Separators       `protobuf:"bytes,16,opt,name=separators" json:"separators,omitempty"`
}
...
func (m *DashboardCell) GetSeparators() *Separators {
	if m != nil {
		return m.Separators
	}
	return nil
...
type Separators struct {
	...
	FormatType string `protobuf:"bytes,2,opt,name=formatType,proto3" json:"formatType,omitempty"`
}

func (m *Separators) Reset()                    { *m = Separators{} }
func (m *Separators) String() string            { return proto.CompactTextString(m) }
func (*Separators) ProtoMessage()               {}
func (*Separators) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{3} }

func (m *Separators) GetIsEnabled() bool {
	if m != nil {
		return m.IsEnabled
	}
	return false
...
func (m *Separators) GetFormatType() string {
	if m != nil {
		return m.FormatType
	}
	return ""
...
func (*DecimalPlaces) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{4} }
...
func init() {
	...
	proto.RegisterType((*Separators)(nil), "internal.Separators")
...
var fileDescriptorInternal = []byte{
	...
	,
}
