...
type Source struct {
	...
	// 	string MetaURL            = 10; // MetaURL is the connection URLs for the meta nodes.
	SharedSecret string   `protobuf:"bytes,11,opt,name=SharedSecret,proto3" json:"SharedSecret,omitempty"`
	MetaURL      []string `protobuf:"bytes,12,rep,name=MetaURL" json:"MetaURL,omitempty"`
}
...
var fileDescriptorInternal = []byte{
	...
	0xed, 0x38, 0xec, 0x2c, 0xda, 0x0b, 0xdc, 0xea, 0xab, 0xea, 0x54, 0x57, 0x57, 0x7d, 0xf5, 0xc5,
	...
	,
}
