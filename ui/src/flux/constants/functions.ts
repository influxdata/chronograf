...
export const FUNCTIONS: FluxToolbarFunction[] = [
  {
    ...
    args: [
      ...
      {
        name: 'unit',
        desc: 'Time duration to use when calculating the rate. Default is `1s`.',
        type: 'Array of Strings',
      },
    ],
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'location',
        desc: 'Location used to determine timezone. Default is the `location` option.',
        type: 'Object',
      },
      {
        name: 'column',
      ...
      {
        name: 'timeSrc',
        desc: 'Column to use as the source of the new time value for aggregate values.',
        type: 'String',
      },
      {
        name: 'timeDst',
  ...
  },
  {
    ...
    args: [
      {
        name: 'token',
        desc: 'Google Cloud IAM token to use to access the Cloud Bigtable database.',
        type: 'String',
      },
      {
        name: 'project',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'pearsonr',
        desc: 'Normalize results to the Pearson R coefficient. Default is `false`.',
        type: 'Boolean',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      {
        name: 'unit',
        desc: 'Time duration used to calculate the derivative. Default is `1s`.',
        type: 'Duration',
      },
      {
        name: 'nonNegative',
  ...
  },
  {
    ...
    args: [
      {
        name: 'columns',
        desc: 'List of columns to remove from input tables. Mutually exclusive with `fn`.',
        type: 'Array of Strings',
      },
      {
        name: 'fn',
        desc: 'Predicate function with a `column` parameter that returns a boolean',
        type: 'Function',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      {
        name: 'columns',
        desc: 'List of columns to use in the grouping operation. Default is `[]`.',
        type: 'Array of Strings',
      },
      {
        name: 'mode',
        desc: 'Grouping mode. `extend` is the only mode available to `experimental.group()`.',
        type: 'String',
      },
    ],
    package: 'experimental',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'fn',
        desc: 'Function with left and right arguments that maps a new output record',
        type: 'Function',
      },
    ],
    package: 'experimental',
    desc: 'Joins two streams of tables on the **group key and `_time` column**.',
    example:
  ...
  },
  {
    ...
    args: [
      {
        name: 'fn',
        desc: 'Single argument predicate function that evaluates `true` or `false`.',
        type: 'Function',
      },
      {
        name: 'onEmpty',
  ...
  },
  {
    ...
    args: [
      {
        name: 'groupBy',
        desc: 'Columns to group by. These columns should uniquely identify each track.',
        type: 'Array of Strings',
      },
      {
        name: 'orderBy',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'level',
        desc: 'S2 cell level (https://s2geometry.io/resources/s2cell_statistics.html)',
        type: 'Integer',
      },
      {
        name: 's2cellIDLevel',
  ...
  },
  {
    ...
    args: [
      {
        name: 'newColumn',
        desc: 'Name of the new column for the unique identifier for each geographic area.',
        type: 'String',
      },
      {
        name: 'level',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'point',
        desc: 'Record with `lat` and `lon` properties that specify the latitude and',
        type: 'Object',
      },
      {
        name: 'level',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'bins',
        desc: 'List of upper bounds to use when computing the histogram frequencies.',
  ...
  },
  {
    ...
    args: [
      {
        name: 'start',
        desc: 'First hour of the hour range (inclusive). Hours range from `[0-23]`.',
        type: 'Integer',
      },
      {
        name: 'stop',
        desc: 'Last hour of the hour range (inclusive). Hours range from `[0-23]`.',
        type: 'Integer`',
      },
      {
        name: 'location',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'fn',
        desc: 'Predicate function that takes a column name as a parameter (column) and',
        type: 'Function',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    category: 'Miscellaneous',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/built-in/misc/length/',
  },
  {
    name: 'limit',
    args: [
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'infinity',
        desc: 'Include an infinite value at the end of the list. Default is `true`.',
        type: 'Boolean',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'mergeKey',
        desc: '_(Deprecated)_ Merge group keys of mapped records. Default is `false`.',
        type: 'Boolean',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'qos',
        desc: 'MQTT Quality of Service (QoS) level. Values range from `[0-2]`. Default is `0`.',
        type: 'Integer',
      },
      {
        name: 'retain',
    ...
    category: 'Outputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/mqtt/to/',
  },
  {
    name: 'pearsonr',
    args: [
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'valueColumn',
        desc: 'Column to use to populate the value of pivoted `columnKey` columns.',
        type: 'String',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'metricVersion',
        desc: 'Prometheus metric parsing format (/influxdb/v2/reference/prometheus-metrics/)',
        type: 'Object',
      },
      {
        name: 'onNonmonotonic',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'predicate',
        desc: 'Predicate function that evaluates column values and returns `true` or `false`.',
        type: 'Function',
      },
    ],
    package: 'experimental/query',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'identity',
        desc: 'Record that defines the reducer record and provides initial values',
        type: 'Object',
      },
    ],
    package: '',
    desc: 'Aggregates rows in each input table using a reducer function (`fn`).',
    example:
  ...
  },
  {
    ...
    args: [
      {
        name: 'v',
        desc: 'String that contains regular expression metacharacters to escape.',
        type: 'String',
      },
    ],
    package: 'regexp',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'fn',
        desc: 'Function that takes the current column name (`column`) and returns a',
        type: 'Function',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'pos',
        desc: 'Position offset from the start of results where sampling begins.',
        type: 'Integer',
      },
      {
        name: 'column',
  ...
  },
  {
    ...
    package: '',
    desc: 'Returns the skew of non-null records in each input table as a float.',
    example: 'import "sampledata"\n\nsampledata.int()\n    |> skew()',
    category: 'Aggregates',
    link:
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'column',
        desc: 'Column to store the state duration in. Default is `stateDuration`.',
        type: 'String',
      },
      {
        name: 'timeColumn',
      ...
      {
        name: 'unit',
        desc: 'Unit of time to use to increment state duration. Default is `1s` (seconds).',
        type: 'Duration',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'mode',
        desc: 'Standard deviation mode or type of standard deviation to calculate.',
        type: 'String',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/strings/lastindexany/',
  },
  {
    name: 'strings.repeat',
    args: [
  ...
  },
  {
    ...
    category: 'Tests',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/testing/assertequals/',
  },
  {
    name: 'testing.diff',
    args: [
      {
        name: 'got',
        desc: 'Stream containing data to test. Default is piped-forward data (`<-`).',
        type: 'Stream of tables',
      },
      {
        name: 'want',
  ...
  },
  {
    ...
    args: [
      {
        name: 'duration',
        desc: 'Amount of time to add to each time value. May be a negative duration.',
        type: 'String',
      },
      {
        name: 'columns',
        desc: 'List of time columns to operate on. Default is `["_start", "_stop", "_time"]`.',
        type: 'Array of Strings',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: 'fieldFn',
        desc: 'Function that maps a field key to a field value and returns a record.',
        type: 'Function',
      },
    ],
    package: '',
  ...
  },
  {
    ...
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/alerta/alert/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/alerta/endpoint/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/anaisdg/anomalydetection/mad/',
  },
  {
    name: 'array.concat',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/array/concat/',
  },
  {
    name: 'array.filter',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/array/filter/',
  },
  {
    name: 'array.from',
    args: [
    ...
    category: 'Inputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/array/from/',
  },
  {
    name: 'array.map',
    args: [
      {
        name: 'arr',
        desc: 'Array to operate on. Defaults is the piped-forward array (`<-`).',
        type: 'Array',
      },
      {
        name: 'fn',
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/array/map/',
  },
  {
    name: 'array.toBool',
    args: [
      {
        name: 'arr',
        desc: 'Array of values to convert. Default is the piped-forward array (`<-`).',
        type: 'Array',
      },
    ],
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/array/tobool/',
  },
  {
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/array/toduration/',
  },
  {
    name: 'array.toFloat',
    args: [
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/array/tofloat/',
  },
  {
    name: 'array.toInt',
    args: [
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/array/toint/',
  },
  {
    name: 'array.toString',
    args: [
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/array/tostring/',
  },
  {
    name: 'array.toTime',
    args: [
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/array/totime/',
  },
  {
    name: 'array.toUInt',
    args: [
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/array/touint/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/rhajek/bigpanda/endpoint/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'status',
        desc: 'BigPanda alert status (https://docs.bigpanda.io/reference#alerts).',
        type: 'Object',
      },
      {
        name: 'rec',
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/rhajek/bigpanda/sendalert/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/rhajek/bigpanda/statusfromlevel/',
  },
  {
    name: 'bitwise.sand',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/sand/',
  },
  {
    name: 'bitwise.sclear',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/sclear/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/slshift/',
  },
  {
    name: 'bitwise.snot',
    args: [
    ...
    example: 'import "bitwise"\n\nbitwise.snot(a: 1234)',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/snot/',
  },
  {
    name: 'bitwise.sor',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/sor/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/srshift/',
  },
  {
    name: 'bitwise.sxor',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/sxor/',
  },
  {
    name: 'bitwise.uand',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/uand/',
  },
  {
    name: 'bitwise.uclear',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/uclear/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/ulshift/',
  },
  {
    name: 'bitwise.unot',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/unot/',
  },
  {
    name: 'bitwise.uor',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/uor/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/urshift/',
  },
  {
    name: 'bitwise.uxor',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/bitwise/uxor/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/friday/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/monday/',
  },
  {
    ...
    args: [
      {
        name: 'month_offset',
        desc: 'Number of months to offset from the current month. Default is `0`.',
        type: 'Integer',
      },
    ],
    package: 'experimental/date/boundaries',
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/month/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/saturday/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/sunday/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/thursday/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/tuesday/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/wednesday/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'week_offset',
        desc: 'Number of weeks to offset from the current week. Default is `0`.',
        type: 'Integer',
      },
    ],
    package: 'experimental/date/boundaries',
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/week/',
  },
  {
    ...
    category: 'Date/time',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/date/boundaries/yesterday/',
  },
  {
    name: 'buckets',
    args: [
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/buckets/',
  },
  {
    ...
    category: 'Inputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/clickhouse/query/',
  },
  {
    name: 'date.add',
    args: [
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/date/add/',
  },
  {
    name: 'date.scale',
    args: [
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/date/scale/',
  },
  {
    name: 'date.sub',
    args: [
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/date/sub/',
  },
  {
    name: 'date.time',
    args: [
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/date/time/',
  },
  {
    name: 'debug.feature',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/debug/feature/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/debug/getoption/',
  },
  {
    name: 'debug.null',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/internal/debug/null/',
  },
  {
    name: 'debug.opaque',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/debug/opaque/',
  },
  {
    name: 'debug.pass',
    args: [],
    ...
    example: 'debug.pass()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/internal/debug/pass/',
  },
  {
    name: 'debug.sink',
    args: [],
    ...
    example: 'debug.sink()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/internal/debug/sink/',
  },
  {
    name: 'debug.slurp',
    args: [],
    ...
    example: 'debug.slurp()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/internal/debug/slurp/',
  },
  {
    name: 'dict.fromList',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/dict/fromlist/',
  },
  {
    name: 'dict.get',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/dict/get/',
  },
  {
    name: 'dict.insert',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/dict/insert/',
  },
  {
    name: 'dict.remove',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/dict/remove/',
  },
  {
    name: 'die',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/universe/die/',
  },
  {
    ...
    args: [
      {
        name: 'webhookToken',
        desc: 'Discord webhook token (https://discord.com/developers/docs/resources/webhook).',
        type: 'String',
      },
      {
        name: 'webhookID',
        desc: 'Discord webhook ID (https://discord.com/developers/docs/resources/webhook).',
        type: 'String',
      },
      {
        name: 'username',
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/chobbs/discord/endpoint/',
  },
  {
    name: 'discord.send',
    args: [
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/chobbs/discord/send/',
  },
  {
    name: 'display',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/universe/display/',
  },
  {
    ...
    args: [
      {
        name: 'v',
        desc: 'Dynamic value to convert. Default is the piped-forward value (`<-`).',
        type: 'Object',
      },
    ],
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/dynamic/asarray/',
  },
  {
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/dynamic/dynamic/',
  },
  {
    name: 'dynamic.isType',
    args: [
    ...
    category: 'Tests',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/dynamic/istype/',
  },
  {
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/dynamic/jsonencode/',
  },
  {
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/dynamic/jsonparse/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/tomhollingworth/events/duration/',
  },
  {
    name: 'expect.planner',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/testing/expect/planner/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/aligntime/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/catch/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/chain/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int()\n    |> experimental.count()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/count/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/diff/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/distinct/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'usePrevious',
        desc: 'Replace null values with the value of the previous non-null row.',
        type: 'Boolean',
      },
    ],
    package: 'experimental',
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/fill/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int(includeNull: true)\n    |> experimental.first()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/first/',
  },
  {
    ...
    args: [
      {
        name: 'bins',
        desc: 'List of upper bounds to use when computing histogram frequencies,',
        type: 'Array',
      },
      {
        name: 'normalize',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/histogram/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/histogramquantile/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'interpolate',
        desc: 'Type of interpolation to use. Default is `""` (no interpolation).',
        type: 'String',
      },
    ],
    package: 'experimental',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/integral/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/kaufmansama/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int(includeNull: true)\n    |> experimental.last()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/last/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int()\n    |> experimental.max()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/max/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.float()\n    |> experimental.mean()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/mean/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int()\n    |> experimental.min()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/min/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int()\n    |> experimental.mode()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/mode/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/preview/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/quantile/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.float()\n    |> experimental.skew()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/skew/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.float()\n    |> experimental.spread()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/spread/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.float()\n    |> experimental.stddev()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/stddev/',
  },
  {
    ...
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int()\n    |> experimental.sum()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/sum/',
  },
  {
    name: 'experimental.unique',
    args: [],
    package: 'experimental',
    desc: 'Returns all records containing unique values in the `_value` column.',
    example:
      'import "experimental"\nimport "sampledata"\n\nsampledata.int(includeNull: true)\n    |> experimental.unique()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/unique/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/unpivot/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/window/',
  },
  {
    name: 'findColumn',
    args: [
    ...
    link: 'https://docs.influxdata.com/flux/latest/stdlib/universe/findcolumn/',
  },
  {
    name: 'findRecord',
    args: [
    ...
    example:
      'import "sampledata"\n\nsampledata.int()\n    |> findRecord(\n        fn: (key) => key.tag == "t1",\n        idx: 0,\n    )',
    category: 'Dynamic queries',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/universe/findrecord/',
  },
  {
    name: 'gen.tables',
    args: [
      ...
      {
        name: 'seed',
        desc: 'Pass seed to tables generator to get the very same sequence each time.',
        type: 'Integer',
      },
    ],
    ...
    example: 'gen.tables()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/internal/gen/tables/',
  },
  {
    name: 'generate.from',
    args: [
    ...
    category: 'Inputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/generate/from/',
  },
  {
    ...
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/st_contains/',
  },
  {
    name: 'geo.ST_DWithin',
    args: [
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/st_dwithin/',
  },
  {
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/st_distance/',
  },
  {
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/st_intersects/',
  },
  {
    name: 'geo.ST_Length',
    args: [
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/st_length/',
  },
  {
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/st_linestring/',
  },
  {
    name: 'geo.getGrid',
    args: [
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/getgrid/',
  },
  {
    name: 'geo.getLevel',
    args: [
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/getlevel/',
  },
  {
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/s2celllatlon/',
  },
  {
    name: 'geo.stContains',
    args: [
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/stcontains/',
  },
  {
    name: 'geo.stDistance',
    args: [
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/stdistance/',
  },
  {
    name: 'geo.stLength',
    args: [
    ...
    category: 'Geotemporal',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/stlength/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/geo/totaldistance/',
  },
  {
    name: 'hash.b64',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/hash/b64/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/hash/cityhash64/',
  },
  {
    name: 'hash.hmac',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/hash/hmac/',
  },
  {
    name: 'hash.md5',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/hash/md5/',
  },
  {
    name: 'hash.sha1',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/hash/sha1/',
  },
  {
    name: 'hash.sha256',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/hash/sha256/',
  },
  {
    name: 'hash.xxhash64',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/hash/xxhash64/',
  },
  {
    name: 'hex.bytes',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/hex/bytes/',
  },
  {
    name: 'hex.int',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/hex/int/',
  },
  {
    name: 'hex.string',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/hex/string/',
  },
  {
    name: 'hex.uint',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/hex/uint/',
  },
  {
    name: 'http.basicAuth',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/http/basicauth/',
  },
  {
    name: 'http.endpoint',
    args: [
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/http/endpoint/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/http/pathescape/',
  },
  {
    name: 'influxdb.api',
    args: [
      ...
      {
        name: 'host',
        desc: 'InfluxDB host URL _(Required when executed outside of InfluxDB)_.',
        type: 'String',
      },
      {
        name: 'token',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/influxdb/api/',
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/cardinality/',
  },
  {
    ...
    category: 'Inputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/jsternberg/influxdb/select/',
  },
  {
    ...
    category: 'Outputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/wideto/',
  },
  {
    ...
    example: 'import "interpolate"\n\ndata\n    |> interpolate.linear(every: 1d)',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/interpolate/linear/',
  },
  {
    name: 'iox.from',
    args: [
    ...
    category: 'Inputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/iox/from/',
  },
  {
    name: 'iox.sql',
    args: [
    ...
    category: 'Inputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/iox/sql/',
  },
  {
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/iox/sqlinterval/',
  },
  {
    name: 'join.full',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/join/full/',
  },
  {
    name: 'join.inner',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/join/inner/',
  },
  {
    name: 'join.left',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/join/left/',
  },
  {
    name: 'join.right',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/join/right/',
  },
  {
    name: 'join.tables',
    args: [
    ...
    example:
      'import "join"\n\n// setup and processing omitted\n\njoin.tables(\n    method: "inner",\n    left: ints,\n    right: strings,\n    on: (l, r) => l._time == r._time,\n    as: (l, r) => ({l with label: r._value}),\n)',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/join/tables/',
  },
  {
    name: 'join.time',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/join/time/',
  },
  {
    name: 'json.parse',
    args: [
    ...
    category: 'Type Conversions',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/json/parse/',
  },
  {
    name: 'kafka.to',
    args: [
    ...
    category: 'Outputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/kafka/to/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'orgid',
        desc: 'Optional Loki organization ID for partitioning. Default is `""`.',
        type: 'String',
      },
    ],
    ...
    category: 'Inputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/qxip/logql/query_range/',
  },
  {
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/math/float64frombits/',
  },
  {
    name: 'math.log10',
    args: [
    ...
    example: 'import "math"\n\nmath.log10(x: 3.14)',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/math/log10/',
  },
  {
    name: 'monitor.check',
    args: [
      ...
      {
        name: 'ok',
        desc: 'Predicate function that determines `ok` status. `Default is (r) => true`.',
        type: 'Function',
      },
      {
        name: 'messageFn',
        desc: 'Predicate function that constructs a message to append to each row.',
        type: 'Function',
      },
      {
        name: 'data',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/check/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/deadman/',
  },
  {
    name: 'monitor.from',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/from/',
  },
  {
    name: 'monitor.log',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/log/',
  },
  {
    name: 'monitor.logs',
    args: [
    ...
    category: 'Inputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/logs/',
  },
  {
    name: 'monitor.notify',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/notify/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/statechanges/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/statechangesonly/',
  },
  {
    name: 'monitor.write',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/monitor/write/',
  },
  {
    name: 'mqtt.publish',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/mqtt/publish/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/RohanSreerama5/naiveBayesClassifier/naivebayes/',
  },
  {
    name: 'now',
    args: [],
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/universe/now/',
  },
  {
    name: 'oee.APQ',
    args: [
    ...
    example: 'oee.APQ()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/experimental/oee/apq/',
  },
  {
    name: 'oee.computeAPQ',
    args: [
      ...
      {
        name: 'partEvents',
        desc: 'Part events that contains the running totals of parts produced and',
        type: 'Stream of tables',
      },
      {
        name: 'runningState',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/oee/computeapq/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/opsgenie/endpoint/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/opsgenie/responderstojson/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/opsgenie/sendalert/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/pagerduty/actionfromlevel/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/pagerduty/actionfromseverity/',
  },
  {
    ...
    args: [
      {
        name: 'exclude',
        desc: 'Group key columns to exclude when generating the deduplication key.',
        type: 'Array',
      },
    ],
    package: 'pagerduty',
    ...
    example:
      'import "pagerduty"\nimport "sampledata"\n\nsampledata.int()\n    |> pagerduty.dedupKey()',
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/pagerduty/dedupkey/',
  },
  {
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/pagerduty/endpoint/',
  },
  {
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/pagerduty/sendevent/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/pagerduty/severityfromlevel/',
  },
  {
    name: 'polyline.rdp',
    args: [
      {
        name: 'valColumn',
        desc: 'Column with Y axis values of the given curve. Default is `_value`.',
        type: 'String',
      },
      {
        name: 'timeColumn',
        desc: 'Column with X axis values of the given curve. Default is `_time`.',
        type: 'String',
      },
      {
        name: 'epsilon',
        desc: 'Maximum tolerance value that determines the amount of compression.',
        type: 'Float',
      },
      {
        name: 'retention',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/polyline/rdp/',
  },
  {
    name: 'promql.changes',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/changes/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/emptytable/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/extrapolatedrate/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/holtwinters/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/instantrate/',
  },
  {
    name: 'promql.join',
    args: [
    ...
    example: 'promql.join()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/join/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/labelreplace/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/linearregression/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promhistogramquantile/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promqldayofmonth/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promqldayofweek/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promqldaysinmonth/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promqlhour/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promqlminute/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promqlmonth/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/promqlyear/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/quantile/',
  },
  {
    name: 'promql.resets',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/resets/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/promql/timestamp/',
  },
  {
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/pushbullet/endpoint/',
  },
  {
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/pushbullet/pushdata/',
  },
  {
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/pushbullet/pushnote/',
  },
  {
    name: 'record.get',
    args: [
      ...
      {
        name: 'default',
        desc: 'Default value to return if the specified key does not exist in the record.',
        type: 'Object',
      },
    ],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/record/get/',
  },
  {
    name: 'requests.do',
    args: [
    ...
    category: 'Inputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/http/requests/do/',
  },
  {
    name: 'requests.get',
    args: [
    ...
    category: 'Inputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/http/requests/get/',
  },
  {
    name: 'requests.peek',
    args: [
    ...
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/http/requests/peek/',
  },
  {
    name: 'requests.post',
    args: [
    ...
    category: 'Inputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/http/requests/post/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/sample/aligntonow/',
  },
  {
    name: 'sample.data',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/sample/data/',
  },
  {
    name: 'sample.list',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/sample/list/',
  },
  {
    ...
    example: 'import "sampledata"\n\nsampledata.bool()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/sampledata/bool/',
  },
  {
    ...
    example: 'import "sampledata"\n\nsampledata.float()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/sampledata/float/',
  },
  {
    name: 'sampledata.int',
    args: [
    ...
    example: 'import "sampledata"\n\nsampledata.int()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/sampledata/int/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/sampledata/numericbool/',
  },
  {
    ...
    example: 'import "sampledata"\n\nsampledata.string()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/sampledata/string/',
  },
  {
    ...
    example: 'import "sampledata"\n\nsampledata.uint()',
    category: 'Transformations',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/sampledata/uint/',
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/schema/fieldkeys/',
  },
  {
  ...
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/schema/measurementfieldkeys/',
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/schema/measurementtagkeys/',
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/schema/measurementtagvalues/',
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/schema/measurements/',
  },
  {
    name: 'schema.tagKeys',
    args: [
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/schema/tagkeys/',
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/schema/tagvalues/',
  },
  {
    name: 'sensu.endpoint',
    args: [
      ...
      {
        name: 'namespace',
        desc: 'Sensu namespace (https://docs.sensu.io/sensu-go/latest/reference/rbac/).',
        type: 'String',
      },
      {
        name: 'entityName',
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/sensu/endpoint/',
  },
  {
    name: 'sensu.event',
    args: [
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/sensu/event/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/sensu/tosensuname/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/servicenow/endpoint/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'messageKey',
        desc: 'Unique identifier of the event (for example, the InfluxDB alert ID).',
        type: 'Object',
      },
      {
        name: 'additionalInfo',
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/servicenow/event/',
  },
  {
    name: 'slack.endpoint',
    args: [
      {
        name: 'url',
        desc: 'Slack API URL. Default is `https://slack.com/api/chat.postMessage`.',
        type: 'String',
      },
      {
        name: 'token',
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/slack/endpoint/',
  },
  {
    name: 'slack.message',
    args: [
    ...
    category: 'Notification endpoints',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/slack/message/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/slack/validatecolorstring/',
  },
  {
    name: 'socket.from',
    args: [
    ...
    category: 'Inputs',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/socket/from/',
  },
  {
    name: 'stateTracking',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/universe/statetracking/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/anaisdg/statsmodels/linearregression/',
  },
  {
    name: 'table.fill',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/table/fill/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/tasks/lastsuccess/',
  },
  {
    name: 'teams.endpoint',
    args: [
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/teams/endpoint/',
  },
  {
    name: 'teams.message',
    args: [
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/teams/message/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'parseMode',
        desc: 'Parse mode (https://core.telegram.org/bots/api#formatting-options)',
        type: 'Object',
      },
      {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/telegram/endpoint/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'silent',
        desc: 'Send message silently (https://telegram.org/blog/channels-2-0#silent-messages).',
        type: 'Object',
      },
    ],
    package: 'contrib/sranka/telegram',
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/telegram/message/',
  },
  {
    ...
    category: 'Tests',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/testing/assertequalvalues/',
  },
  {
    ...
    category: 'Tests',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/testing/assertmatches/',
  },
  {
    name: 'testing.load',
    args: [],
    ...
    category: 'Tests',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/testing/load/',
  },
  {
    ...
    category: 'Tests',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/testing/shoulderror/',
  },
  {
    ...
    category: 'Tests',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/testing/shoulderrorwithcode/',
  },
  {
    name: 'testutil.fail',
    args: [],
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/testutil/fail/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/testutil/makeany/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/testutil/makerecord/',
  },
  {
    name: 'testutil.yield',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/internal/testutil/yield/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'id',
        desc: 'Function that returns the InfluxDB check ID provided by the check record.',
        type: 'Function',
      },
      {
        name: 'details',
        desc: 'Function to return the InfluxDB check details using data from input rows.',
        type: 'Function',
      },
      {
        name: 'message',
        desc: 'Function to return the InfluxDB check message using data from input rows.',
        type: 'Function',
      },
      {
        name: 'crit',
      ...
      {
        name: 'ok',
        desc: 'Predicate function to determine `ok` status. Default is `(r) => true`.',
        type: 'Function',
      },
      {
        name: 'topic',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/alert/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/compute/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'message',
        desc: 'Function that returns the InfluxDB check message using data from input rows.',
        type: 'Function',
      },
      {
        name: 'topic',
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/deadman/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/definecheck/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/groupby/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/join/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/select/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/tickscript/selectwindow/',
  },
  {
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/universe/timeweightedavg/',
  },
  {
    name: 'timezone.fixed',
    args: [
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/timezone/fixed/',
  },
  {
    ...
    args: [
      {
        name: 'name',
        desc: 'Location name (as defined by your operating system timezone database).',
        type: 'String',
      },
    ],
    package: 'timezone',
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/timezone/location/',
  },
  {
    name: 'today',
    args: [],
    ...
    category: 'Date/time',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/universe/today/',
  },
  {
    ...
    category: 'Tests',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/types/isnumeric/',
  },
  {
    name: 'types.isType',
    args: [
    ...
    category: 'Tests',
    link: 'https://docs.influxdata.com/flux/latest/stdlib/types/istype/',
  },
  {
    name: 'usage.from',
    args: [
      ...
      {
        name: 'raw',
        desc: 'Return raw, high resolution usage data instead of downsampled usage data.',
        type: 'Object',
      },
    ],
    ...
    category: 'Inputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/usage/from/',
  },
  {
    name: 'usage.limits',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/experimental/usage/limits/',
  },
  {
    name: 'v1.databases',
    args: [
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/v1/databases/',
  },
  {
    name: 'v1.fieldKeys',
    args: [
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/v1/fieldkeys/',
  },
  {
    name: 'v1.json (file)',
    args: [
      {
        name: 'file',
        desc: 'File path to file containing InfluxDB 1.x query results in JSON format.',
        type: 'String',
      },
    ],
    package: 'influxdata/influxdb/v1',
    ...
    category: 'Inputs',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/v1/json/',
  },
  {
  ...
  },
  {
    ...
    category: 'Metadata',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/influxdata/influxdb/v1/measurementfieldkeys/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/victorops/alert/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/victorops/endpoint/',
  },
  {
    ...
    args: [
      ...
      {
        name: 'token',
        desc: 'Webex API access token (https://developer.webex.com/docs/api/getting-started).',
        type: 'String',
      },
    ],
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/webexteams/endpoint/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/sranka/webexteams/message/',
  },
  {
    ...
    category: 'Notification endpoints',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/zenoss/endpoint/',
  },
  {
    name: 'zenoss.event',
    args: [
    ...
    category: 'Transformations',
    link:
      'https://docs.influxdata.com/flux/latest/stdlib/contrib/bonitoo-io/zenoss/event/',
  },
]
